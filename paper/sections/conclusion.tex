...
keyword baseline is blind to flawed-but-plausible evidence ($0.182$ detection)
while a model that judges evidence adequacy recovers it ($1.000$, no false
alarms)---evidence that presence is not adequacy. Scaling this from synthetic
fixtures to a real, expert-annotated corpus with humans in the loop is the
doctoral programme. We believe auditing identification credibility is both a
tractable and a responsible role for AI in empirical environmental-policy
research.
