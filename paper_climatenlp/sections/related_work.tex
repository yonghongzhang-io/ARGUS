...
either alone leaves the ranking uninformative. Our compute-graded ablation
(\S\ref{sec:ablation}) is the same move applied inward, separating what the
rubric and retrieval layer contribute from what the model does. Where ReAct-style agents~\cite{yao2023react} choose
their own action sequence, \sys{} \emph{bounds} the paradigm (agency confined to two
