...
model can \emph{carry out} inference: CausalVerify~\cite{causalverify} runs
generated estimation code against synthetic data; \sys{} audits the prior
layer---whether identification \emph{assumptions} are supported by reported
evidence---and builds on that benchmark's released economics
corpus~\cite{causalverify_dataset}.
